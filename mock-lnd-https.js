...
const key = readFileSync('/home/chelo/antigravity/cherito/cherito-bitcoin-payments-sdk/secrets/key.pem');
const cert = readFileSync('/home/chelo/antigravity/cherito/cherito-bitcoin-payments-sdk/secrets/cert.pem');
...
const PORT = 8081;
server.listen(PORT, () => {
  console.log(`Mock LND REST server running at https://localhost:${PORT}`);
