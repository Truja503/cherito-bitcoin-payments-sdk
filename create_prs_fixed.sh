...
# We are already on feat/20-ssrf-defense but the PR failed. 
# Let's just create PR for it first.
gh pr create --repo Truja503/cherito-bitcoin-payments-sdk --base main --head "marchelo23:feat/20-ssrf-defense" --title "feat: SSRF defense in LND provider (#20)" --body "Closes #20. Adds SSRF defenses to LndRestProvider." || true
...
for i in {1..8}; do
  ...
  gh pr create --repo Truja503/cherito-bitcoin-payments-sdk --base main --head "marchelo23:$branch" --title "$title" --body "$body"
done
